...
Notification bodies put the zone name on the FIRST line and the status on the
second: Telegram's notification preview shows only the opening lines, and with
the flavour text first the zone was cut off exactly where it mattered.
...
LOCALES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "prealert_head": "Next terror zone in 15 minutes",
        "rotation_head": "Terror zone is live now",
        "prealert": "Warriors of Sanctuary, the corruption begins to fade.",
        "rotation": "Warriors of Sanctuary, corrupted tremors strike.",
    ...
    "ru": {
        ...
        "prealert_head": "Следующая зона ужаса через 15 минут",
        "rotation_head": "Зона ужаса сменилась",
        "prealert": "Воины Санктуария, толчки сбавляют интенсивность.",
        "rotation": "Воины Санктуария, тлетворные толчки снова бушуют!",
    ...
    "uk": {
        ...
        "prealert_head": "Наступна зона жаху за 15 хвилин",
        "rotation_head": "Зона жаху змінилася",
        "prealert": "Воїни Святилища, поштовхи зменшують інтенсивність.",
        "rotation": "Воїни Святилища, тлетворні поштовхи знову вирують!",
    ...
    "zh": {
        ...
        "unsubscribed": "通知已关闭。",
        "prealert_head": "下一个恐怖区域将在15分钟后开始",
        "rotation_head": "恐怖区域已轮换",
        "prealert": "圣域战士们，腐化开始消退。",
        "rotation": "圣域战士们，腐化震颤再次袭来。",
    ...
    "pt": {
        ...
        "prealert_head": "Próxima zona de terror em 15 minutos",
        "rotation_head": "A zona de terror mudou",
        "prealert": "Guerreiros do Santuário, a corrupção começa a desaparecer.",
        "rotation": "Guerreiros do Santuário, tremores corrompidos atacam.",
    ...
    "de": {
        ...
        "prealert_head": "Nächste Terrorzone in 15 Minuten",
        "rotation_head": "Die Terrorzone hat gewechselt",
        "prealert": "Krieger des Heiligtums, die Korruption beginnt zu verblassen.",
        "rotation": "Krieger des Heiligtums, korrupte Erschütterungen schlagen zu.",
